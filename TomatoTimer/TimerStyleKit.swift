...
open class TimerStyleKit: NSObject {
    ...
    fileprivate struct Cache {
        static var backgroundColor = UIColor(red: 0.141, green: 0.149, blue: 0.204, alpha: 1.000)
        static var timerColor = UIColor(red: 0.378, green: 0.670, blue: 0.961, alpha: 1.000)
