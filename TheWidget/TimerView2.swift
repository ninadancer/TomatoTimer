...
class TimerView2: UIView {
    ...
    var timerCenter: CGPoint = CGPoint(x: 0.0, y: 0.0)
    ...
    override init(frame: CGRect) {
        ...
        timeLabel = {
            ...
            label.textColor = TimerStyleKit2.timerColor
            return label
        }()
    ...
    private func settingTimerRingStyle() {
        ...
        timerShapeLayer.strokeColor = TimerStyleKit2.timerColor.cgColor
    ...
    private func settingSecondsRingStyle() {
        ...
        secondsShapeLayer.strokeColor = TimerStyleKit2.timerColor.cgColor
        secondsShapeLayer.lineWidth = 1.0
    }
    
    private func settingFullRingStyle() {
        TimerStyleKit2.timerColor.set()
